    ...
    public partial class Turnos : Form
    {
        ...
        private void txtBusqueda_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                sql_con.Open();
                sql_cmd = sql_con.CreateCommand();
                string CommandText = "select CODIGO, FECHA, APELLIDO, HORA_RESERVA, OBSERVACIONES from turnos where FECHA like ('" + txtBusqueda.Text + "%')";
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string txtQuery = "insert into reservas (FECHA, APELLIDO, HORA_RESERVA, OBSERVACIONES) values ('" + textBox2.Text + "', '" + textBox3.Text + "', '" + textBox4.Text + "', '" + textBox5.Text + "' )";
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string txtQuery = "update reservas Set FECHA = '" + textBox2.Text + "', APELLIDO = '" + textBox3.Text + "', HORA_RESERVA ='" + textBox4.Text + "', OBSERVACIONES = '" + textBox5.Text + "' where CODIGO = '" + textBox1.Text + "' ";
                    ExecuteQuery(txtQuery);
                    LoadData();
