...
namespace Barberia
{
    public partial class Barbero : Form
    {
        public Barbero()
        {
            InitializeComponent();
        ...
        private void Barbero_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void txtBusqueda_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                sql_con.Open();
                sql_cmd = sql_con.CreateCommand();
                string CommandText = "select count(CODIGO) As Cortes_totales, sum(Valor_corte) As Total_recaudado, Fecha, Barbero from Cortes where Barbero like ('" + txtBusqueda.Text + "%')";
