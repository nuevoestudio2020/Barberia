...
namespace Barberia
{
    public partial class CortesRealizados : Form
    {
        public CortesRealizados()
        {
            InitializeComponent();
        }
        ...
        private void CortesRealizados_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void txtBusqueda_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                sql_con.Open();
                sql_cmd = sql_con.CreateCommand();
                string CommandText = "select count(CODIGO) As Cortes_totales, sum(Valor_corte) As Total_recaudado, Fecha from cortes where FECHA like ('" + txtBusqueda.Text + "%')";
